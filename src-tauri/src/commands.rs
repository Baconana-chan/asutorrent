...
use crate::torrent_mgr::{ManagerHandle, RssFeed, RssFilter, ScheduleRule};
use crate::trackers;
...
pub async fn update_torrent_files(
    ...
    let tm = mgr.get().map_err(|e| e.to_string())?;
    tm.update_only_files(id, indices)
        .await
        .map_err(|e| e.to_string())
}
...
pub async fn get_queue_config(mgr: State<'_, Mgr>) -> Result<Value, String> {
    ...
    Ok(
        serde_json::json!({ "max_active_downloads": q.max_active_downloads, "max_active_seeds": q.max_active_seeds }),
    )
}
...
#[tauri::command]
pub async fn set_normal_download_limit(
    mgr: State<'_, Mgr>,
    bps: Option<u32>,
) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_normal_download_limit(bps);
    Ok(())
}
#[tauri::command]
pub async fn set_normal_upload_limit(mgr: State<'_, Mgr>, bps: Option<u32>) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_normal_upload_limit(bps);
    Ok(())
}
#[tauri::command]
pub async fn set_turtle_download_limit(
    mgr: State<'_, Mgr>,
    bps: Option<u32>,
) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_turtle_download_limit(bps);
    Ok(())
}
#[tauri::command]
...
pub async fn set_speed_schedule(
    ...
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_schedule_rules(rules, enabled);
    Ok(())
}
...
pub async fn remove_rss_feed(mgr: State<'_, Mgr>, id: u32) -> Result<(), String> {
    mgr.get().map_err(|e| e.to_string())?.remove_rss_feed(id);
    Ok(())
}
...
pub async fn update_rss_feed(
    ...
    mgr.get()
        .map_err(|e| e.to_string())?
        .update_rss_feed(id, name, url, interval_secs);
    Ok(())
}

#[tauri::command]
pub async fn add_rss_filter(
    mgr: State<'_, Mgr>,
    feed_id: u32,
    name_regex: String,
    min_size: Option<u64>,
    max_size: Option<u64>,
    add_torrent: bool,
) -> Result<RssFilter, String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .add_rss_filter(feed_id, name_regex, min_size, max_size, add_torrent)
        .ok_or_else(|| "Feed not found".to_string())
}

#[tauri::command]
pub async fn remove_rss_filter(
    mgr: State<'_, Mgr>,
    feed_id: u32,
    filter_id: u32,
) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .remove_rss_filter(feed_id, filter_id);
    Ok(())
}
...
pub async fn add_category(
    ...
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .add_category(name, icon, save_path, auto_rule))
}

#[tauri::command]
pub async fn remove_category(mgr: State<'_, Mgr>, id: u32) -> Result<(), String> {
    mgr.get().map_err(|e| e.to_string())?.remove_category(id);
    Ok(())
}
...
pub async fn update_category(
    ...
    mgr.get()
        .map_err(|e| e.to_string())?
        .update_category(id, name, icon, save_path, auto_rule);
    Ok(())
}
...
pub async fn add_tag(
    ...
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .add_tag(name, color, auto_rule))
}

#[tauri::command]
pub async fn remove_tag(mgr: State<'_, Mgr>, id: u32) -> Result<(), String> {
    mgr.get().map_err(|e| e.to_string())?.remove_tag(id);
    Ok(())
}
...
#[tauri::command]
pub async fn set_global_download_path(
    mgr: State<'_, Mgr>,
    path: Option<String>,
) -> Result<(), String> {
    mgr.get()
...
pub async fn set_torrent_category(
    ...
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_torrent_category(torrent_id, category_id);
    Ok(())
}

#[tauri::command]
pub async fn get_torrent_category(
    mgr: State<'_, Mgr>,
    torrent_id: u32,
    ...
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .get_torrent_category(torrent_id))
}
...
pub async fn set_torrent_tags(
    ...
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_torrent_tags(torrent_id, tag_ids);
    Ok(())
}
...
pub async fn get_history(
    mgr: State<'_, Mgr>,
) -> Result<Vec<crate::torrent_mgr::TorrentHistoryEntry>, String> {
    let tm = mgr.get().map_err(|e| e.to_string())?;
    Ok(tm.get_history())
}
...
#[tauri::command]
pub async fn get_auto_management_config(
    mgr: State<'_, Mgr>,
) -> Result<crate::config::AutoManagementConfig, String> {
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .get_auto_management_config())
}

#[tauri::command]
pub async fn set_auto_management_config(
    mgr: State<'_, Mgr>,
    config: crate::config::AutoManagementConfig,
) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_auto_management_config(config);
    Ok(())
}
...
pub async fn set_global_disable_dht(mgr: State<'_, Mgr>, disabled: bool) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_global_disable_dht(disabled);
    Ok(())
}
...
pub async fn set_global_disable_pex(mgr: State<'_, Mgr>, disabled: bool) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_global_disable_pex(disabled);
    Ok(())
}
...
pub async fn set_global_disable_lpd(mgr: State<'_, Mgr>, disabled: bool) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_global_disable_lpd(disabled);
    Ok(())
}
...
pub async fn create_torrent_file(
    ...
    std::fs::write(output, &buf).map_err(|e| format!("Failed to write torrent file: {}", e))?;

    log::info!(
        "Created .torrent file: {} ({} bytes, {} trackers)",
        output_path,
        buf.len(),
        trackers.len()
    );
...
pub async fn add_portfolio(
    ...
    icon: String,
    filter: String,
) -> Result<crate::config::Portfolio, String> {
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .add_portfolio(name, icon, filter))
}
...
pub async fn update_portfolio(
    ...
    mgr.get()
        .map_err(|e| e.to_string())?
        .update_portfolio(id, name, icon, filter);
    Ok(())
}
...
pub async fn set_encryption_mode(mgr: State<'_, Mgr>, mode: String) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_encryption_mode(mode);
    Ok(())
}

#[tauri::command]
pub async fn get_torrent_encryption(
    mgr: State<'_, Mgr>,
    id: u32,
    ...
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .get_torrent_encryption(id))
}

#[tauri::command]
pub async fn set_torrent_encryption(
    mgr: State<'_, Mgr>,
    id: u32,
    mode: Option<String>,
) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_torrent_encryption(id, mode);
    Ok(())
}
...
pub async fn get_global_utp_enabled(mgr: State<'_, Mgr>) -> Result<Option<bool>, String> {
    Ok(mgr
        .get()
        .map_err(|e| e.to_string())?
        .get_global_utp_enabled())
}

#[tauri::command]
pub async fn set_global_utp_enabled(
    mgr: State<'_, Mgr>,
    enabled: Option<bool>,
) -> Result<(), String> {
    mgr.get()
        .map_err(|e| e.to_string())?
        .set_global_utp_enabled(enabled);
    Ok(())
}
...
fn register_default_client_windows(exe_path: &str) -> Result<(), String> {
    ...
    let (app_key, _) = hkcu
        .create_subkey("Software\\Classes\\asutorrent")
        .map_err(|e| e.to_string())?;
    app_key
        .set_value("", &"AsuTorrent")
        .map_err(|e| e.to_string())?;
    app_key
        .set_value("FriendlyTypeName", &"AsuTorrent")
        .map_err(|e| e.to_string())?;
    ...
    let (magnet_key, _) = hkcu
        ...
        .map_err(|e| e.to_string())?;
    magnet_key
        .set_value("", &"URL:Magnet Link")
        .map_err(|e| e.to_string())?;
    magnet_key
        .set_value("URL Protocol", &"")
        .map_err(|e| e.to_string())?;
    let (magnet_cmd_key, _) = magnet_key
        .create_subkey("shell\\open\\command")
        .map_err(|e| e.to_string())?;
    magnet_cmd_key
        .set_value("", &format!("\"{}\" \"%1\"", exe_path))
    ...
    torrent_key
        .set_value("", &"asutorrent")
        .map_err(|e| e.to_string())?;
    let (torrent_cmd_key, _) = hkcu
        .create_subkey("Software\\Classes\\asutorrent\\DefaultIcon")
        .map_err(|e| e.to_string())?;
    torrent_cmd_key
        .set_value("", &format!("\"{}\",1", exe_path))
        .map_err(|e| e.to_string())?;
...
#[tauri::command]
pub async fn export_torrents_to_file(
    mgr: State<'_, Mgr>,
    path: String,
    format: String,
) -> Result<u32, String> {
    ...
    match format.as_str() {
        ...
        "csv" => {
            let mut csv = String::from(
                "name,info_hash,size,downloaded,uploaded,state,finished,forced,sequential\n",
            );
            for t in &torrents {
...
#[tauri::command]
pub async fn import_torrents_from_file(
    mgr: State<'_, Mgr>,
    path: String,
...
async fn import_torrents_json_inner(
    tm: &Arc<crate::torrent_mgr::TorrentManager>,
    json_data: &str,
) -> Result<Vec<u32>, String> {
...
async fn import_torrents_csv_inner(
    tm: &Arc<crate::torrent_mgr::TorrentManager>,
    csv_data: &str,
) -> Result<Vec<u32>, String> {
    let mut ids = Vec::new();
    for line in csv_data.lines().skip(1) {
        ...
        let url_or_ih = fields.first().map(|s| s.as_str()).unwrap_or("");
        let info_hash = fields.get(1).map(|s| s.as_str()).unwrap_or("");
        let url = if url_or_ih.starts_with("magnet:")
            || url_or_ih.starts_with("http")
            || url_or_ih.starts_with("ftp")
        {
            Some(url_or_ih.to_string())
        } else if info_hash.starts_with("magnet:")
            || info_hash.starts_with("http")
            || info_hash.starts_with("ftp")
        {
...
pub async fn export_torrents_csv(mgr: State<'_, Mgr>) -> Result<String, String> {
    ...
    let mut csv =
        String::from("name,info_hash,size,downloaded,uploaded,state,finished,forced,sequential\n");
    for t in &torrents {
        let name = t["name"].as_str().unwrap_or("").replace('"', "\"\"");
        let info_hash = t["info_hash"].as_str().unwrap_or("");
        let size = t["stats"]["total_bytes"].as_u64().unwrap_or(0);
...
#[tauri::command]
pub async fn import_torrents_json(
    mgr: State<'_, Mgr>,
    json_data: String,
) -> Result<Vec<u32>, String> {
    let tm = mgr.get().map_err(|e| e.to_string())?;
...
#[tauri::command]
pub async fn import_torrents_csv(
    mgr: State<'_, Mgr>,
    csv_data: String,
) -> Result<Vec<u32>, String> {
    let tm = mgr.get().map_err(|e| e.to_string())?;
    ...
    for line in csv_data.lines().skip(1) {
        ...
        let url_or_ih = fields.first().copied().unwrap_or("");
...
pub async fn start_http_download(
    mgr: &Arc<crate::torrent_mgr::TorrentManager>,
    url: &str,
) -> Result<u32, String> {
    let download_dir = {
        ...
        std::path::PathBuf::from(
            cfg.effective_path(None)
                .unwrap_or_else(|| mgr.data_dir.to_string_lossy().to_string()),
        )
    };
    ...
    let save_path = {
        ...
        downloads
            .get(&id)
            .map(|dl| dl.save_path.clone())
            .unwrap_or_else(|| download_dir.join("download").to_string_lossy().to_string())
    };
...
async fn do_http_download_task(
    mgr: &Arc<crate::torrent_mgr::TorrentManager>,
    id: u32,
    url: &str,
    save_path: &str,
...
#[tauri::command]
pub async fn search_trackers(
    query: String,
    sources: Vec<String>,
) -> Result<Vec<trackers::SearchResult>, String> {
